...
![OpenAL](https://img.shields.io/badge/OpenAL-Spatial%20Audio-4A90E2)
![Edge AI](https://img.shields.io/badge/Edge%20AI-On--device-2E8B57)
...
- Edge AI: 카메라, 레이더, STT, VLM을 Raspberry Pi에서 로컬로 처리해 네트워크 의존성을 제거했습니다.
